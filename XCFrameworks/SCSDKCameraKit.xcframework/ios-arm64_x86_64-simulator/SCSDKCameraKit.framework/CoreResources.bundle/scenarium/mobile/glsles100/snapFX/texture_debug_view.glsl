...
#endif
l9_4=sc_SampleTextureBiasOrLevel(leftTextureDims.xy,leftTextureLayout,l9_5,l9_0,(int(SC_USE_UV_TRANSFORM_leftTexture)!=0),leftTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_leftTexture,SC_SOFTWARE_WRAP_MODE_V_leftTexture),(int(SC_USE_UV_MIN_MAX_leftTexture)!=0),leftTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_leftTexture)!=0),leftTextureBorderColor,0.0,leftTexture);
...
#endif
l9_7=sc_SampleTextureBiasOrLevel(rightTextureDims.xy,rightTextureLayout,l9_8,l9_0,(int(SC_USE_UV_TRANSFORM_rightTexture)!=0),rightTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_rightTexture,SC_SOFTWARE_WRAP_MODE_V_rightTexture),(int(SC_USE_UV_MIN_MAX_rightTexture)!=0),rightTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_rightTexture)!=0),rightTextureBorderColor,0.0,rightTexture);
...
if (l9_3)
{
float l9_10=depthScreenToViewSpace(l9_4.x)/depthRange;
l9_9=vec4(l9_10,l9_10,l9_10,1.0);
}
else
{
l9_9=l9_4;
}
sc_writeFragData0(l9_9);
}
