...
#endif
{
mat3 cameraTextureTransform;
vec4 cameraTextureUvMinMax;
vec4 cameraTextureBorderColor;
vec4 leftSampleOffsetSize;
vec4 rightSampleOffsetSize;
} userUniformsObj;
in vec4 position;
in vec2 texture0;
...
void main()
{
mat3 l9_0=userUniformsObj.cameraTextureTransform;
l9_0[0].x=userUniformsObj.cameraTextureTransform[0].x*userUniformsObj.leftSampleOffsetSize.z;
mat3 l9_1=l9_0;
l9_1[1].y=userUniformsObj.cameraTextureTransform[1].y*userUniformsObj.leftSampleOffsetSize.w;
mat3 l9_2=userUniformsObj.cameraTextureTransform;
l9_2[0].x=userUniformsObj.cameraTextureTransform[0].x*userUniformsObj.rightSampleOffsetSize.z;
mat3 l9_3=l9_2;
l9_3[1].y=userUniformsObj.cameraTextureTransform[1].y*userUniformsObj.rightSampleOffsetSize.w;
vec3 l9_4=vec3((texture0*vec2(2.0))-vec2(1.0),1.0);
varLerp=1.0-texture0.x;
varLeftSampleCoord=(((l9_4*l9_1).xy+userUniformsObj.leftSampleOffsetSize.xy)*0.5)+vec2(0.5);
varRightSampleCoord=(((l9_4*l9_3).xy+userUniformsObj.rightSampleOffsetSize.xy)*0.5)+vec2(0.5);
...
{
vec4 l9_6;
if (sc_CameraUBO_obj.sc_ProjectionMatrixArray[0][2].w!=0.0)
{
vec4 l9_7=position;
l9_7.z=((log2(max(sc_CameraUBO_obj.sc_Camera.clipPlanes.x,1.0+position.w))*(2.0/log2(sc_CameraUBO_obj.sc_Camera.clipPlanes.y+1.0)))-1.0)*position.w;
l9_6=l9_7;
}
else
{
...
{
vec4 l9_10=l9_8;
l9_10.x=l9_8.x+(sc_CameraUBO_obj.sc_UniformConstants.x*float(sc_ShaderCacheConstant));
l9_9=l9_10;
}
#else
{
...
{
l9_0=sc_SampleTextureBias(cameraTextureLayout,cameraTextureGetStereoViewIndex(),varLeftSampleCoord,false,mat3(vec3(1.0,0.0,0.0),vec3(0.0,1.0,0.0),vec3(0.0,0.0,1.0)),ivec2(SC_SOFTWARE_WRAP_MODE_U_cameraTexture,SC_SOFTWARE_WRAP_MODE_V_cameraTexture),(int(SC_USE_UV_MIN_MAX_cameraTexture)!=0),userUniformsObj.cameraTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_cameraTexture)!=0),userUniformsObj.cameraTextureBorderColor,0.0,cameraTextureArrSC);
}
#else
{
l9_0=sc_SampleTextureBias(cameraTextureLayout,cameraTextureGetStereoViewIndex(),varLeftSampleCoord,false,mat3(vec3(1.0,0.0,0.0),vec3(0.0,1.0,0.0),vec3(0.0,0.0,1.0)),ivec2(SC_SOFTWARE_WRAP_MODE_U_cameraTexture,SC_SOFTWARE_WRAP_MODE_V_cameraTexture),(int(SC_USE_UV_MIN_MAX_cameraTexture)!=0),userUniformsObj.cameraTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_cameraTexture)!=0),userUniformsObj.cameraTextureBorderColor,0.0,cameraTexture);
}
#endif
vec4 l9_1;
#if (cameraTextureLayout==2)
...
#endif
vec3 l9_2=mix(l9_0.xyz,l9_1.xyz,vec3(varLerp));
float l9_3=l9_2.x;
vec4 l9_4=vec4(l9_3,l9_2.yz,1.0);
vec4 l9_5;
#if (sc_ShaderCacheConstant!=0)
{
vec4 l9_6=l9_4;
l9_6.x=l9_3+(sc_CameraUBO_obj.sc_UniformConstants.x*float(sc_ShaderCacheConstant));
l9_5=l9_6;
}
#else
{
