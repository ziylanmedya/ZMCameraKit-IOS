...
vec2 l9_1=inputTextureSize.zw*blurDir;
blurCoordinates[0]=varTex01.xy;
vec2 l9_2=l9_1*offset.x;
blurCoordinates[1]=varTex01.xy+l9_2;
blurCoordinates[2]=varTex01.xy-l9_2;
vec2 l9_3=l9_1*offset.y;
blurCoordinates[3]=varTex01.xy+l9_3;
blurCoordinates[4]=varTex01.xy-l9_3;
vec2 l9_4=l9_1*offset.z;
blurCoordinates[5]=varTex01.xy+l9_4;
blurCoordinates[6]=varTex01.xy-l9_4;
vec4 l9_5;
#if (sc_StereoRenderingMode==1)
{
vec4 l9_6=position;
l9_6.y=(position.y*0.5)+(0.5-float(sc_GetStereoViewIndex()));
l9_5=l9_6;
}
#else
{
...
varScreenPos=l9_5;
vec2 l9_7=((l9_5.xy/vec2(l9_5.w))*0.5)+vec2(0.5);
vec2 l9_8;
#if (sc_StereoRenderingMode==1)
{
vec3 l9_9=vec3(l9_7,0.0);
l9_9.y=((2.0*l9_7.y)+float(sc_GetStereoViewIndex()))-1.0;
l9_8=l9_9.xy;
}
#else
{
...
vec4 sampleInputTexture(vec2 uv)
{
vec4 l9_0;
#if (inputTextureLayout==2)
{
l9_0=sc_SampleTextureBias(inputTextureLayout,inputTextureGetStereoViewIndex(),uv,(int(SC_USE_UV_TRANSFORM_inputTexture)!=0),inputTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_inputTexture,SC_SOFTWARE_WRAP_MODE_V_inputTexture),(int(SC_USE_UV_MIN_MAX_inputTexture)!=0),inputTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_inputTexture)!=0),inputTextureBorderColor,0.0,inputTextureArrSC);
}
#else
{
l9_0=sc_SampleTextureBias(inputTextureLayout,inputTextureGetStereoViewIndex(),uv,(int(SC_USE_UV_TRANSFORM_inputTexture)!=0),inputTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_inputTexture,SC_SOFTWARE_WRAP_MODE_V_inputTexture),(int(SC_USE_UV_MIN_MAX_inputTexture)!=0),inputTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_inputTexture)!=0),inputTextureBorderColor,0.0,inputTexture);
...
float sampleMaskTexture(vec2 uv)
{
vec4 l9_0;
#if (maskTextureLayout==2)
{
l9_0=sc_SampleTextureBias(maskTextureLayout,maskTextureGetStereoViewIndex(),uv,(int(SC_USE_UV_TRANSFORM_maskTexture)!=0),maskTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskTexture,SC_SOFTWARE_WRAP_MODE_V_maskTexture),(int(SC_USE_UV_MIN_MAX_maskTexture)!=0),maskTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_maskTexture)!=0),maskTextureBorderColor,0.0,maskTextureArrSC);
}
#else
{
l9_0=sc_SampleTextureBias(maskTextureLayout,maskTextureGetStereoViewIndex(),uv,(int(SC_USE_UV_TRANSFORM_maskTexture)!=0),maskTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskTexture,SC_SOFTWARE_WRAP_MODE_V_maskTexture),(int(SC_USE_UV_MIN_MAX_maskTexture)!=0),maskTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_maskTexture)!=0),maskTextureBorderColor,0.0,maskTexture);
}
#endif
return l9_0.x;
}
...
#endif
vec4 l9_0=sampleInputTexture(blurCoordinates[0]);
vec4 l9_1=sampleInputTexture(blurCoordinates[1]);
vec4 l9_2=sampleInputTexture(blurCoordinates[2]);
vec4 l9_3=sampleInputTexture(blurCoordinates[3]);
vec4 l9_4=sampleInputTexture(blurCoordinates[4]);
vec4 l9_5=sampleInputTexture(blurCoordinates[5]);
vec4 l9_6=sampleInputTexture(blurCoordinates[6]);
vec4 l9_7=(((l9_0*weight.x)+((l9_1+l9_2)*weight.y))+((l9_3+l9_4)*weight.z))+((l9_5+l9_6)*weight.w);
float l9_8=sampleMaskTexture(blurCoordinates[0]);
float l9_9=sampleMaskTexture(blurCoordinates[1]);
float l9_10=sampleMaskTexture(blurCoordinates[2]);
float l9_11=sampleMaskTexture(blurCoordinates[3]);
