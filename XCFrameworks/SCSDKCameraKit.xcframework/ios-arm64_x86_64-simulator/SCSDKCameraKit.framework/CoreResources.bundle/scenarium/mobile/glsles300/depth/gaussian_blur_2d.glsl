...
void main()
{
float l9_0=0.0*mainTextureSize.z;
float l9_1=0.0*mainTextureSize.w;
blurCoordinates[0]=texture0+vec2(l9_0,l9_1);
float l9_2=1.182426*mainTextureSize.z;
blurCoordinates[1]=texture0+vec2(l9_2,l9_1);
float l9_3=1.182426*mainTextureSize.w;
blurCoordinates[2]=texture0+vec2(l9_0,l9_3);
float l9_4=(-1.182426)*mainTextureSize.z;
blurCoordinates[3]=texture0+vec2(l9_4,l9_1);
float l9_5=(-1.182426)*mainTextureSize.w;
blurCoordinates[4]=texture0+vec2(l9_0,l9_5);
blurCoordinates[5]=texture0+vec2(l9_2,l9_3);
blurCoordinates[6]=texture0+vec2(l9_4,l9_3);
blurCoordinates[7]=texture0+vec2(l9_4,l9_5);
blurCoordinates[8]=texture0+vec2(l9_2,l9_5);
vec4 l9_6;
#if (sc_StereoRenderingMode==1)
{
vec4 l9_7=position;
l9_7.y=(position.y*0.5)+(0.5-float(sc_GetStereoViewIndex()));
l9_6=l9_7;
}
#else
{
...
#endif
varPosAndMotion=vec4(l9_6.x,l9_6.y,l9_6.z,varPosAndMotion.w);
varTex01=vec4(texture0.x,texture0.y,varTex01.z,varTex01.w);
varScreenPos=l9_6;
vec2 l9_8=((l9_6.xy/vec2(l9_6.w))*0.5)+vec2(0.5);
vec2 l9_9;
#if (sc_StereoRenderingMode==1)
{
...
{
vec4 l9_11=sc_ProjectorMatrix*position;
varShadowTex=((l9_11.xy/vec2(l9_11.w))*0.5)+vec2(0.5);
}
#endif
vec4 l9_12=l9_6*1.0;
vec4 l9_13;
...
{
vec4 l9_14=l9_12;
l9_14.x=l9_12.x+(sc_UniformConstants.x*float(sc_ShaderCacheConstant));
l9_13=l9_14;
}
#else
{
...
#if (sc_StereoRenderingMode==1)
{
float l9_15=dot(l9_13,sc_StereoClipPlanes[sc_StereoViewID]);
#if (sc_StereoRendering_IsClipDistanceEnabled==1)
{
sc_SetClipDistancePlatform(l9_15);
}
#else
{
varClipDistance=l9_15;
}
#endif
}
#endif
...
#endif
return ((vec2(dot(l9_0.xy,vec2(1.0,0.0039215689)),dot(l9_0.zw,vec2(1.0,0.0039215689)))*0.162103)+((((vec2(dot(l9_1.xy,vec2(1.0,0.0039215689)),dot(l9_1.zw,vec2(1.0,0.0039215689)))+vec2(dot(l9_2.xy,vec2(1.0,0.0039215689)),dot(l9_2.zw,vec2(1.0,0.0039215689))))+vec2(dot(l9_3.xy,vec2(1.0,0.0039215689)),dot(l9_3.zw,vec2(1.0,0.0039215689))))+vec2(dot(l9_4.xy,vec2(1.0,0.0039215689)),dot(l9_4.zw,vec2(1.0,0.0039215689))))*0.120259))+((((vec2(dot(l9_5.xy,vec2(1.0,0.0039215689)),dot(l9_5.zw,vec2(1.0,0.0039215689)))+vec2(dot(l9_6.xy,vec2(1.0,0.0039215689)),dot(l9_6.zw,vec2(1.0,0.0039215689))))+vec2(dot(l9_7.xy,vec2(1.0,0.0039215689)),dot(l9_7.zw,vec2(1.0,0.0039215689))))+vec2(dot(l9_8.xy,vec2(1.0,0.0039215689)),dot(l9_8.zw,vec2(1.0,0.0039215689))))*0.089216001);
}
vec4 blur_x()
{
vec4 l9_0;
...
#if (mainTextureLayout==2)
{
l9_3=sc_SampleTextureBias(mainTextureLayout,mainTextureGetStereoViewIndex(),blurCoordinates[2],(int(SC_USE_UV_TRANSFORM_mainTexture)!=0),mainTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTexture,SC_SOFTWARE_WRAP_MODE_V_mainTexture),(int(SC_USE_UV_MIN_MAX_mainTexture)!=0),mainTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_mainTexture)!=0),mainTextureBorderColor,0.0,mainTextureArrSC);
}
#else
{
l9_3=sc_SampleTextureBias(mainTextureLayout,mainTextureGetStereoViewIndex(),blurCoordinates[2],(int(SC_USE_UV_TRANSFORM_mainTexture)!=0),mainTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTexture,SC_SOFTWARE_WRAP_MODE_V_mainTexture),(int(SC_USE_UV_MIN_MAX_mainTexture)!=0),mainTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_mainTexture)!=0),mainTextureBorderColor,0.0,mainTexture);
...
#if (mainTextureLayout==2)
{
l9_5=sc_SampleTextureBias(mainTextureLayout,mainTextureGetStereoViewIndex(),blurCoordinates[3],(int(SC_USE_UV_TRANSFORM_mainTexture)!=0),mainTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTexture,SC_SOFTWARE_WRAP_MODE_V_mainTexture),(int(SC_USE_UV_MIN_MAX_mainTexture)!=0),mainTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_mainTexture)!=0),mainTextureBorderColor,0.0,mainTextureArrSC);
}
#else
{
l9_5=sc_SampleTextureBias(mainTextureLayout,mainTextureGetStereoViewIndex(),blurCoordinates[3],(int(SC_USE_UV_TRANSFORM_mainTexture)!=0),mainTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTexture,SC_SOFTWARE_WRAP_MODE_V_mainTexture),(int(SC_USE_UV_MIN_MAX_mainTexture)!=0),mainTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_mainTexture)!=0),mainTextureBorderColor,0.0,mainTexture);
...
#if (mainTextureLayout==2)
{
l9_7=sc_SampleTextureBias(mainTextureLayout,mainTextureGetStereoViewIndex(),blurCoordinates[4],(int(SC_USE_UV_TRANSFORM_mainTexture)!=0),mainTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTexture,SC_SOFTWARE_WRAP_MODE_V_mainTexture),(int(SC_USE_UV_MIN_MAX_mainTexture)!=0),mainTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_mainTexture)!=0),mainTextureBorderColor,0.0,mainTextureArrSC);
}
#else
{
l9_7=sc_SampleTextureBias(mainTextureLayout,mainTextureGetStereoViewIndex(),blurCoordinates[4],(int(SC_USE_UV_TRANSFORM_mainTexture)!=0),mainTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTexture,SC_SOFTWARE_WRAP_MODE_V_mainTexture),(int(SC_USE_UV_MIN_MAX_mainTexture)!=0),mainTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_mainTexture)!=0),mainTextureBorderColor,0.0,mainTexture);
...
#if (mainTextureLayout==2)
{
l9_9=sc_SampleTextureBias(mainTextureLayout,mainTextureGetStereoViewIndex(),blurCoordinates[5],(int(SC_USE_UV_TRANSFORM_mainTexture)!=0),mainTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTexture,SC_SOFTWARE_WRAP_MODE_V_mainTexture),(int(SC_USE_UV_MIN_MAX_mainTexture)!=0),mainTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_mainTexture)!=0),mainTextureBorderColor,0.0,mainTextureArrSC);
}
#else
{
l9_9=sc_SampleTextureBias(mainTextureLayout,mainTextureGetStereoViewIndex(),blurCoordinates[5],(int(SC_USE_UV_TRANSFORM_mainTexture)!=0),mainTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTexture,SC_SOFTWARE_WRAP_MODE_V_mainTexture),(int(SC_USE_UV_MIN_MAX_mainTexture)!=0),mainTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_mainTexture)!=0),mainTextureBorderColor,0.0,mainTexture);
...
#if (mainTextureLayout==2)
{
l9_10=sc_SampleTextureBias(mainTextureLayout,mainTextureGetStereoViewIndex(),blurCoordinates[6],(int(SC_USE_UV_TRANSFORM_mainTexture)!=0),mainTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTexture,SC_SOFTWARE_WRAP_MODE_V_mainTexture),(int(SC_USE_UV_MIN_MAX_mainTexture)!=0),mainTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_mainTexture)!=0),mainTextureBorderColor,0.0,mainTextureArrSC);
}
#else
{
l9_10=sc_SampleTextureBias(mainTextureLayout,mainTextureGetStereoViewIndex(),blurCoordinates[6],(int(SC_USE_UV_TRANSFORM_mainTexture)!=0),mainTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTexture,SC_SOFTWARE_WRAP_MODE_V_mainTexture),(int(SC_USE_UV_MIN_MAX_mainTexture)!=0),mainTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_mainTexture)!=0),mainTextureBorderColor,0.0,mainTexture);
...
#endif
vec4 l9_11=l9_9+l9_10;
vec4 l9_12;
#if (mainTextureLayout==2)
{
l9_12=sc_SampleTextureBias(mainTextureLayout,mainTextureGetStereoViewIndex(),blurCoordinates[7],(int(SC_USE_UV_TRANSFORM_mainTexture)!=0),mainTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTexture,SC_SOFTWARE_WRAP_MODE_V_mainTexture),(int(SC_USE_UV_MIN_MAX_mainTexture)!=0),mainTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_mainTexture)!=0),mainTextureBorderColor,0.0,mainTextureArrSC);
}
#else
{
l9_12=sc_SampleTextureBias(mainTextureLayout,mainTextureGetStereoViewIndex(),blurCoordinates[7],(int(SC_USE_UV_TRANSFORM_mainTexture)!=0),mainTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTexture,SC_SOFTWARE_WRAP_MODE_V_mainTexture),(int(SC_USE_UV_MIN_MAX_mainTexture)!=0),mainTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_mainTexture)!=0),mainTextureBorderColor,0.0,mainTexture);
...
#endif
vec4 l9_13=l9_11+l9_12;
vec4 l9_14;
#if (mainTextureLayout==2)
{
l9_14=sc_SampleTextureBias(mainTextureLayout,mainTextureGetStereoViewIndex(),blurCoordinates[8],(int(SC_USE_UV_TRANSFORM_mainTexture)!=0),mainTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTexture,SC_SOFTWARE_WRAP_MODE_V_mainTexture),(int(SC_USE_UV_MIN_MAX_mainTexture)!=0),mainTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_mainTexture)!=0),mainTextureBorderColor,0.0,mainTextureArrSC);
}
#else
{
l9_14=sc_SampleTextureBias(mainTextureLayout,mainTextureGetStereoViewIndex(),blurCoordinates[8],(int(SC_USE_UV_TRANSFORM_mainTexture)!=0),mainTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTexture,SC_SOFTWARE_WRAP_MODE_V_mainTexture),(int(SC_USE_UV_MIN_MAX_mainTexture)!=0),mainTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_mainTexture)!=0),mainTextureBorderColor,0.0,mainTexture);
...
#endif
return (l9_1+(l9_8*0.120259))+((l9_13+l9_14)*0.089216001);
}
void main()
{
