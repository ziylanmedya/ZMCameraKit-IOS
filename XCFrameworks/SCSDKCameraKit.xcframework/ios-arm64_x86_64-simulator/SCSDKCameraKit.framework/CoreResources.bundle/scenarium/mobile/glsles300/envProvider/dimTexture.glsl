...
//spec_const bool SC_USE_UV_MIN_MAX_mainTexture 3 0
//spec_const bool SC_USE_UV_TRANSFORM_baseTex 4 0
//spec_const bool SC_USE_UV_TRANSFORM_mainTexture 5 0
//spec_const bool baseTexHasSwappedViews 6 0
//spec_const bool mainTextureHasSwappedViews 7 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 8 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_mainTexture 9 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 10 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_mainTexture 11 -1
//spec_const int baseTexLayout 12 0
//spec_const int mainTextureLayout 13 0
...
void main()
{
vec2 l9_0=vec2((mainTextureTransform*vec3(texture0,1.0)).xy)-vec2(0.5);
vec4 l9_1=vec4(sign(l9_0.x),sign(l9_0.y),0.0,1.0);
...
#if (baseTexLayout==2)
{
l9_0=sc_SampleTextureBias(baseTexLayout,baseTexGetStereoViewIndex(),vec2(0.5),(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTexArrSC);
}
#else
{
l9_0=sc_SampleTextureBias(baseTexLayout,baseTexGetStereoViewIndex(),vec2(0.5),(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
...
#endif
sc_writeFragData0Internal(vec4(mix(l9_1.xyz,l9_1.xyz*(0.92000002/max(dot(l9_1.xyz,vec3(0.29899999,0.58700001,0.114)),0.92000002)),vec3(smoothstep(0.15000001,0.34999999,l9_0.x))),1.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
