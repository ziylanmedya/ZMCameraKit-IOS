...
//sampler sampler bgTextureSmpSC 0:8
//sampler sampler lutTextureSmpSC 0:9
//texture texture2D bgTexture 0:0:0:8
//texture texture2D lutTexture 0:1:0:9
//texture texture2DArray bgTextureArrSC 0:16:0:8
//texture texture2DArray lutTextureArrSC 0:17:0:9
//spec_const bool LINEAR_LUT 0 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_bgTexture 1 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_lutTexture 2 0
//spec_const bool SC_USE_UV_MIN_MAX_bgTexture 3 0
//spec_const bool SC_USE_UV_MIN_MAX_lutTexture 4 0
//spec_const bool SC_USE_UV_TRANSFORM_bgTexture 5 0
//spec_const bool SC_USE_UV_TRANSFORM_lutTexture 6 0
//spec_const bool bgTextureHasSwappedViews 7 0
//spec_const bool lutTextureHasSwappedViews 8 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_bgTexture 9 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_lutTexture 10 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_bgTexture 11 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_lutTexture 12 -1
//spec_const int bgTextureLayout 13 0
//spec_const int lutTextureLayout 14 0
//spec_const int sc_ShaderCacheConstant 15 0
//spec_const int sc_StereoRenderingMode 16 0
//spec_const int sc_StereoRendering_IsClipDistanceEnabled 17 0
//spec_const int sc_StereoViewID 18 0
//SG_REFLECTION_END
...
uniform mediump sampler2DArray lutTextureArrSC;
...
int lutTextureGetStereoViewIndex()
{
int l9_0;
...
{
vec4 l9_2;
#if (lutTextureLayout==2)
{
l9_2=sc_SampleTextureBias(lutTextureLayout,lutTextureGetStereoViewIndex(),vec2(l9_0.z,0.5),(int(SC_USE_UV_TRANSFORM_lutTexture)!=0),lutTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_lutTexture,SC_SOFTWARE_WRAP_MODE_V_lutTexture),(int(SC_USE_UV_MIN_MAX_lutTexture)!=0),lutTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_lutTexture)!=0),lutTextureBorderColor,0.0,lutTextureArrSC);
}
#else
{
l9_2=sc_SampleTextureBias(lutTextureLayout,lutTextureGetStereoViewIndex(),vec2(l9_0.z,0.5),(int(SC_USE_UV_TRANSFORM_lutTexture)!=0),lutTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_lutTexture,SC_SOFTWARE_WRAP_MODE_V_lutTexture),(int(SC_USE_UV_MIN_MAX_lutTexture)!=0),lutTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_lutTexture)!=0),lutTextureBorderColor,0.0,lutTexture);
}
#endif
mediump vec4 l9_3=vec4(0.0);
l9_3.x=l9_2.x;
vec4 l9_4;
#if (lutTextureLayout==2)
{
l9_4=sc_SampleTextureBias(lutTextureLayout,lutTextureGetStereoViewIndex(),vec2(l9_0.y,0.5),(int(SC_USE_UV_TRANSFORM_lutTexture)!=0),lutTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_lutTexture,SC_SOFTWARE_WRAP_MODE_V_lutTexture),(int(SC_USE_UV_MIN_MAX_lutTexture)!=0),lutTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_lutTexture)!=0),lutTextureBorderColor,0.0,lutTextureArrSC);
}
#else
{
l9_4=sc_SampleTextureBias(lutTextureLayout,lutTextureGetStereoViewIndex(),vec2(l9_0.y,0.5),(int(SC_USE_UV_TRANSFORM_lutTexture)!=0),lutTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_lutTexture,SC_SOFTWARE_WRAP_MODE_V_lutTexture),(int(SC_USE_UV_MIN_MAX_lutTexture)!=0),lutTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_lutTexture)!=0),lutTextureBorderColor,0.0,lutTexture);
...
#endif
mediump vec4 l9_5=l9_3;
l9_5.y=l9_4.y;
vec4 l9_6;
#if (lutTextureLayout==2)
{
l9_6=sc_SampleTextureBias(lutTextureLayout,lutTextureGetStereoViewIndex(),vec2(l9_0.x,0.5),(int(SC_USE_UV_TRANSFORM_lutTexture)!=0),lutTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_lutTexture,SC_SOFTWARE_WRAP_MODE_V_lutTexture),(int(SC_USE_UV_MIN_MAX_lutTexture)!=0),lutTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_lutTexture)!=0),lutTextureBorderColor,0.0,lutTextureArrSC);
}
#else
{
l9_6=sc_SampleTextureBias(lutTextureLayout,lutTextureGetStereoViewIndex(),vec2(l9_0.x,0.5),(int(SC_USE_UV_TRANSFORM_lutTexture)!=0),lutTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_lutTexture,SC_SOFTWARE_WRAP_MODE_V_lutTexture),(int(SC_USE_UV_MIN_MAX_lutTexture)!=0),lutTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_lutTexture)!=0),lutTextureBorderColor,0.0,lutTexture);
...
#endif
mediump vec4 l9_7=l9_5;
l9_7.z=l9_6.z;
l9_1=l9_7;
}
#else
{
float l9_8=l9_0.z*63.0;
...
float l9_13=0.12304688*l9_0.x;
float l9_14=0.12304688*l9_0.y;
vec2 l9_15=vec2((((l9_9-(l9_10*8.0))*0.125)+0.0009765625)+l9_13,((1.0-(l9_10*0.125))-0.0009765625)-l9_14);
vec2 l9_16=vec2((((l9_11-(l9_12*8.0))*0.125)+0.0009765625)+l9_13,((1.0-(l9_12*0.125))-0.0009765625)-l9_14);
#if (lutTextureLayout==2)
{
}
#else
...
#endif
sc_writeFragData0Internal(vec4(l9_1.xyz,opacity),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
