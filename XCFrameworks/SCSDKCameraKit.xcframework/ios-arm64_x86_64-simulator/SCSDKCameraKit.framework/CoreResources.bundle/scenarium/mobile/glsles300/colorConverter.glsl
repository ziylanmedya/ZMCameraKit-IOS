...
//spec_const bool SWAP_R_B_CHANNELS 3 0
//spec_const bool inputTextureHasSwappedViews 4 0
...
#endif
sc_writeFragData0Internal(vec4(dot(l9_49,vec4(0.29899999,0.58700001,0.114,0.0))),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
