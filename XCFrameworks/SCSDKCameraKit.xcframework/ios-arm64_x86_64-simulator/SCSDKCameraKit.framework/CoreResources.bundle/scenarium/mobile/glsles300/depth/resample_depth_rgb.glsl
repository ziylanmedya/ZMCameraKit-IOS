...
//sampler sampler mainTextureSmpSC 0:9
//texture texture2D depthTexture 0:0:0:8
//texture texture2D mainTexture 0:1:0:9
//texture texture2DArray depthTextureArrSC 0:16:0:8
//texture texture2DArray mainTextureArrSC 0:17:0:9
//spec_const bool BY_Y 0 0
//spec_const bool CAMEOS_MATTING 1 0
//spec_const bool RY_GY 2 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_depthTexture 3 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_mainTexture 4 0
//spec_const bool SC_USE_UV_MIN_MAX_depthTexture 5 0
...
//spec_const bool depthTextureHasSwappedViews 9 0
//spec_const bool mainTextureHasSwappedViews 10 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_depthTexture 11 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_mainTexture 12 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_depthTexture 13 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_mainTexture 14 -1
//spec_const int depthTextureLayout 15 0
//spec_const int mainTextureLayout 16 0
//spec_const int sc_ShaderCacheConstant 17 0
...
{
l9_1=sc_SampleTextureBias(depthTextureLayout,depthTextureGetStereoViewIndex(),varTex01.xy,(int(SC_USE_UV_TRANSFORM_depthTexture)!=0),depthTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_depthTexture,SC_SOFTWARE_WRAP_MODE_V_depthTexture),(int(SC_USE_UV_MIN_MAX_depthTexture)!=0),depthTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_depthTexture)!=0),depthTextureBorderColor,0.0,depthTextureArrSC);
}
#else
{
...
#if (CAMEOS_MATTING)
{
l9_2=clamp(l9_1.x,0.0,0.99998999);
}
#else
{
l9_2=clamp(depthToDisparityNumerator/(l9_1.x+9.9999997e-06),0.0,0.99998999);
}
#endif
vec4 l9_3;
#if (BY_Y)
{
vec2 l9_4=fract(vec2(1.0,255.0)*(l9_0.z*l9_2));
float l9_5=l9_4.y;
vec2 l9_6=fract(vec2(1.0,255.0)*l9_2);
float l9_7=l9_6.y;
l9_3=vec4(l9_4.x-(l9_5/255.0),l9_5,l9_6.x-(l9_7/255.0),l9_7);
}
#else
{
vec4 l9_8;
#if (RY_GY)
{
vec2 l9_9=fract(vec2(1.0,255.0)*(l9_0.x*l9_2));
float l9_10=l9_9.y;
vec2 l9_11=fract(vec2(1.0,255.0)*(l9_0.y*l9_2));
float l9_12=l9_11.y;
l9_8=vec4(l9_9.x-(l9_10/255.0),l9_10,l9_11.x-(l9_12/255.0),l9_12);
}
#else
{
l9_8=vec4(1.0,0.0,1.0,1.0);
}
#endif
l9_3=l9_8;
}
