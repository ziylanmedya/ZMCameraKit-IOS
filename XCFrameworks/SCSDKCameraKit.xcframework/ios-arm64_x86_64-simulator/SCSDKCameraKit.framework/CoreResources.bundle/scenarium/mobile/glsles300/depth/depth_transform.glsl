...
//sampler sampler mainTextureSmpSC 0:7
//texture texture2D mainTexture 0:0:0:7
//texture texture2DArray mainTextureArrSC 0:14:0:7
//spec_const bool SC_USE_CLAMP_TO_BORDER_mainTexture 0 0
//spec_const bool SC_USE_UV_MIN_MAX_mainTexture 1 0
//spec_const bool SC_USE_UV_TRANSFORM_mainTexture 2 0
//spec_const bool mainTextureHasSwappedViews 3 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_mainTexture 4 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_mainTexture 5 -1
//spec_const int mainTextureLayout 6 0
...
vec4 l9_59=l9_54*1.0;
vec4 l9_60;
#if (sc_ShaderCacheConstant!=0)
{
vec4 l9_61=l9_59;
l9_61.x=l9_59.x+(sc_UniformConstants.x*float(sc_ShaderCacheConstant));
l9_60=l9_61;
}
#else
{
...
#if (sc_StereoRenderingMode==1)
{
float l9_62=dot(l9_60,sc_StereoClipPlanes[sc_StereoViewID]);
#if (sc_StereoRendering_IsClipDistanceEnabled==1)
{
sc_SetClipDistancePlatform(l9_62);
}
#else
{
varClipDistance=l9_62;
}
#endif
}
#endif
...
int l9_1=l9_0/256;
sc_writeFragData0Internal(vec4(float(l9_1)/255.0,float(l9_0-(l9_1*256))/255.0,0.0,1.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
