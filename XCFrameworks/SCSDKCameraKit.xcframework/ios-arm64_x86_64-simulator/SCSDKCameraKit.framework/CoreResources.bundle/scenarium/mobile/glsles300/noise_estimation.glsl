...
float l9_6=linearToSrgb(l9_5.x);
float l9_7=linearToSrgb(l9_5.y);
float l9_8=linearToSrgb(l9_5.z);
vec4 l9_9=vec4(l9_6,l9_7,l9_8,l9_0.w);
vec4 l9_10;
#if (sc_ShaderCacheConstant!=0)
{
vec4 l9_11=l9_9;
l9_11.x=l9_6+(sc_UniformConstants.x*float(sc_ShaderCacheConstant));
l9_10=l9_11;
}
#else
{
