...
#endif
vec3 l9_4=l9_1.xyz*sc_SampleTextureBiasOrLevel(mainTextureDims.xy,mainTextureLayout,l9_3,l9_2,(int(SC_USE_UV_TRANSFORM_mainTexture)!=0),mainTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTexture,SC_SOFTWARE_WRAP_MODE_V_mainTexture),(int(SC_USE_UV_MIN_MAX_mainTexture)!=0),mainTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_mainTexture)!=0),mainTextureBorderColor,0.0,mainTexture).x;
float l9_5=l9_4.z;
varDepth=l9_5;
vec4 l9_6=vec4(l9_4.x,l9_4.y,l9_4.z,l9_1.w);
l9_6.y=-l9_4.y;
vec4 l9_7=l9_6;
l9_7.z=-l9_5;
sc_ProcessVertex(sc_Vertex_t(l9_7,l9_0.normal,l9_0.tangent,l9_2,l9_0.texture1));
}
...
int l9_1=l9_0/256;
sc_writeFragData0(vec4(float(l9_1)/255.0,float(l9_0-(l9_1*256))/255.0,0.0,1.0));
}
