...
#if __VERSION__>=310
layout(binding=0,std140) uniform sc_BonesUBO
#else
layout( std140) uniform sc_BonesUBO
#endif
{
#if sc_SkinBonesCount==0
sc_Bone_t sc_Bones[1];
#else
sc_Bone_t sc_Bones[sc_SkinBonesCount];
#endif
} sc_BonesUBO_obj;
#if __VERSION__>=310
...
#endif
{
mat3 lookupTextureTransform;
vec4 lookupTextureUvMinMax;
vec4 lookupTextureBorderColor;
mat3 maskTextureTransform;
vec4 maskTextureUvMinMax;
vec4 maskTextureBorderColor;
...
#if (sc_SkinBonesCount>0)
{
l9_0=vec3(dot(v,sc_BonesUBO_obj.sc_Bones[i].boneMatrix[0]),dot(v,sc_BonesUBO_obj.sc_Bones[i].boneMatrix[1]),dot(v,sc_BonesUBO_obj.sc_Bones[i].boneMatrix[2]));
}
#else
{
l9_0=v.xyz;
...
#if (EYE_SHARPEN)
{
float l9_5=sc_CameraUBO_obj.sc_Camera.aspect/1280.0;
float l9_6=-l9_5;
...
blendTargetShapeWithNormal(l9_15,blendShape0Pos,blendShape0Normal,sc_DrawCallUBO_obj.weights0.x);
blendTargetShapeWithNormal(l9_15,blendShape1Pos,blendShape1Normal,sc_DrawCallUBO_obj.weights0.y);
blendTargetShapeWithNormal(l9_15,blendShape2Pos,blendShape2Normal,sc_DrawCallUBO_obj.weights0.z);
l9_14=l9_15.position;
l9_13=l9_15.texture1;
}
#else
{
vec3 l9_17=(((((position.xyz+(blendShape0Pos*sc_DrawCallUBO_obj.weights0.x)).xyz+(blendShape1Pos*sc_DrawCallUBO_obj.weights0.y)).xyz+(blendShape2Pos*sc_DrawCallUBO_obj.weights0.z)).xyz+(blendShape3Pos*sc_DrawCallUBO_obj.weights0.w)).xyz+(blendShape4Pos*sc_DrawCallUBO_obj.weights1.x)).xyz+(blendShape5Pos*sc_DrawCallUBO_obj.weights1.y);
...
{
l9_24=sc_CameraUBO_obj.sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*l9_18;
}
#else
{
vec4 l9_25;
...
{
l9_25=sc_DrawCallUBO_obj.sc_ModelViewProjectionMatrixArray[sc_GetStereoViewIndex()]*l9_18;
}
#else
{
vec4 l9_26;
...
{
l9_26=sc_ApplyScreenSpaceInstancedClippedShift((sc_DrawCallUBO_obj.sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_18)*vec4(1.0/sc_CameraUBO_obj.sc_Camera.aspect,1.0,1.0,1.0));
}
#else
{
l9_26=l9_18;
...
#if (sc_RenderingSpace==1)
{
vec4 l9_27=sc_DrawCallUBO_obj.sc_ModelMatrix*l9_18;
...
#if (sc_RenderingSpace==1)
{
l9_31=sc_DrawCallUBO_obj.sc_ModelMatrix*l9_18;
}
#else
{
l9_31=l9_18;
...
#endif
vec4 l9_32=sc_DrawCallUBO_obj.sc_ProjectorMatrix*l9_31;
...
#if (sc_RenderingSpace==3)
{
l9_33=sc_CameraUBO_obj.sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*l9_18;
}
#else
{
vec4 l9_34;
#if (sc_RenderingSpace==2)
{
l9_34=sc_CameraUBO_obj.sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_18;
}
#else
{
vec4 l9_35;
#if (sc_RenderingSpace==1)
{
l9_35=sc_DrawCallUBO_obj.sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_18;
}
#else
{
l9_35=l9_18;
...
{
vec4 l9_38=l9_23;
l9_38.z=((log2(max(sc_CameraUBO_obj.sc_Camera.clipPlanes.x,1.0+l9_23.w))*(2.0/log2(sc_CameraUBO_obj.sc_Camera.clipPlanes.y+1.0)))-1.0)*l9_23.w;
l9_37=l9_38;
}
else
{
...
{
vec4 l9_41=l9_39;
l9_41.x=l9_39.x+(sc_CameraUBO_obj.sc_UniformConstants.x*float(sc_ShaderCacheConstant));
l9_40=l9_41;
}
#else
{
...
#if (sc_StereoRenderingMode==1)
{
float l9_42=dot(l9_40,sc_CameraUBO_obj.sc_StereoClipPlanes[sc_StereoViewID]);
...
#else
{
vec2 l9_1=gl_FragCoord.xy*sc_CameraUBO_obj.sc_CurrentRenderTargetDims.zw;
vec2 l9_2;
#if (sc_StereoRenderingMode==1)
{
...
{
l9_4=sc_SampleTextureBias(maskTextureLayout,maskTextureGetStereoViewIndex(),varTex01.zw,(int(SC_USE_UV_TRANSFORM_maskTexture)!=0),userUniformsObj.maskTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskTexture,SC_SOFTWARE_WRAP_MODE_V_maskTexture),(int(SC_USE_UV_MIN_MAX_maskTexture)!=0),userUniformsObj.maskTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_maskTexture)!=0),userUniformsObj.maskTextureBorderColor,0.0,maskTextureArrSC);
}
#else
{
l9_4=sc_SampleTextureBias(maskTextureLayout,maskTextureGetStereoViewIndex(),varTex01.zw,(int(SC_USE_UV_TRANSFORM_maskTexture)!=0),userUniformsObj.maskTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskTexture,SC_SOFTWARE_WRAP_MODE_V_maskTexture),(int(SC_USE_UV_MIN_MAX_maskTexture)!=0),userUniformsObj.maskTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_maskTexture)!=0),userUniformsObj.maskTextureBorderColor,0.0,maskTexture);
}
#endif
vec4 l9_5;
#if (SOFT_SKIN)
...
vec4 l9_13=exp((l9_12*l9_12)*((-1.0)/((2.0*userUniformsObj.softSkinRadius)*userUniformsObj.softSkinRadius)))*0.36787945;
...
#endif
l9_5=mix(l9_0,l9_16,vec4(l9_4.x*userUniformsObj.softSkinIntensity));
}
#else
{
l9_5=l9_0;
...
#if (EYE_SHARPEN)
{
l9_18=clamp(mix(l9_5,((((l9_5*5.0)-sc_ScreenTextureSampleViewBias(varCustomTex0.zw,0.0))-sc_ScreenTextureSampleViewBias(varCustomTex1.zw,0.0))-sc_ScreenTextureSampleViewBias(varCustomTex2.zw,0.0))-sc_ScreenTextureSampleViewBias(varCustomTex3.zw,0.0),vec4(l9_4.z*userUniformsObj.sharpenEyeIntensity)),vec4(0.0),vec4(1.0));
}
#else
{
l9_18=l9_5;
...
#if (EYE_WHITENING)
{
l9_19=0.0+(l9_4.z*userUniformsObj.eyeWhiteningIntensity);
}
#else
{
l9_19=0.0;
...
#if (TEETH_WHITENING)
{
l9_20=l9_19+(l9_4.y*userUniformsObj.teethWhiteningIntensity);
}
#else
{
l9_20=l9_19;
...
{
l9_35=sc_SampleTextureBias(lookupTextureLayout,lookupTextureGetStereoViewIndex(),l9_24.xy,(int(SC_USE_UV_TRANSFORM_lookupTexture)!=0),userUniformsObj.lookupTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_lookupTexture,SC_SOFTWARE_WRAP_MODE_V_lookupTexture),(int(SC_USE_UV_MIN_MAX_lookupTexture)!=0),userUniformsObj.lookupTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_lookupTexture)!=0),userUniformsObj.lookupTextureBorderColor,0.0,lookupTextureArrSC);
}
#else
{
l9_35=sc_SampleTextureBias(lookupTextureLayout,lookupTextureGetStereoViewIndex(),l9_24.xy,(int(SC_USE_UV_TRANSFORM_lookupTexture)!=0),userUniformsObj.lookupTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_lookupTexture,SC_SOFTWARE_WRAP_MODE_V_lookupTexture),(int(SC_USE_UV_MIN_MAX_lookupTexture)!=0),userUniformsObj.lookupTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_lookupTexture)!=0),userUniformsObj.lookupTextureBorderColor,0.0,lookupTexture);
}
#endif
vec4 l9_36;
#if (lookupTextureLayout==2)
...
{
vec4 l9_38=l9_21;
l9_38.x=l9_21.x+(sc_CameraUBO_obj.sc_UniformConstants.x*float(sc_ShaderCacheConstant));
l9_37=l9_38;
}
#else
{
