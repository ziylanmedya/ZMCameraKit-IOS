...
#endif
#if __VERSION__>=310
layout(binding=1,std140) uniform sc_DrawCallUBO
#else
...
{
vec4 l9_0=sc_DrawCallUBO_obj.sc_ProjectorMatrix*position;
...
{
vec4 l9_3=position;
l9_3.z=((log2(max(sc_CameraUBO_obj.sc_Camera.clipPlanes.x,1.0+position.w))*(2.0/log2(sc_CameraUBO_obj.sc_Camera.clipPlanes.y+1.0)))-1.0)*position.w;
l9_2=l9_3;
}
else
{
...
{
vec4 l9_6=l9_4;
l9_6.x=l9_4.x+(sc_CameraUBO_obj.sc_UniformConstants.x*float(sc_ShaderCacheConstant));
l9_5=l9_6;
}
#else
{
...
#if (COLOR_SOURCE)
{
l9_49=l9_0*userUniformsObj.baseColor;
}
#else
{
l9_49=vec4(userUniformsObj.baseColor.xyz,l9_0.x*userUniformsObj.baseColor.w);
}
#endif
vec4 l9_50;
#if (R)
...
{
vec4 l9_53=l9_50;
l9_53.x=l9_50.x+(sc_CameraUBO_obj.sc_UniformConstants.x*float(sc_ShaderCacheConstant));
l9_52=l9_53;
}
#else
{
