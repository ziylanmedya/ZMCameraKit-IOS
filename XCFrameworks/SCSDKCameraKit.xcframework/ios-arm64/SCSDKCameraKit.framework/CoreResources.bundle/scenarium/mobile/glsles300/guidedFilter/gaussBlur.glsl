...
//sampler sampler texMainSmpSC 0:13
//texture texture2D texMain 0:6:0:13
//texture texture2DArray texMainArrSC 0:17:0:13
//spec_const bool SC_USE_CLAMP_TO_BORDER_texMain 0 0
//spec_const bool SC_USE_UV_MIN_MAX_texMain 1 0
//spec_const bool texMainHasSwappedViews 2 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_texMain 3 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_texMain 4 -1
...
//spec_const int texMainLayout 9 0
//SG_REFLECTION_END
...
#endif
gl_Position=l9_6;
vec2 l9_10=(position.xy*0.5)+vec2(0.5);
vec2 l9_11=texMainSize.zw*blurVector;
blurCoordinates[0]=l9_10;
vec2 l9_12=l9_11*1.4584301;
blurCoordinates[1]=l9_10+l9_12;
blurCoordinates[2]=l9_10-l9_12;
vec2 l9_13=l9_11*3.403985;
blurCoordinates[3]=l9_10+l9_13;
blurCoordinates[4]=l9_10-l9_13;
vec2 l9_14=l9_11*5.3518062;
blurCoordinates[5]=l9_10+l9_14;
blurCoordinates[6]=l9_10-l9_14;
}
...
#if (texMainLayout==2)
{
l9_0=sc_SampleTextureBias(texMainLayout,texMainGetStereoViewIndex(),uv,false,mat3(vec3(1.0,0.0,0.0),vec3(0.0,1.0,0.0),vec3(0.0,0.0,1.0)),ivec2(SC_SOFTWARE_WRAP_MODE_U_texMain,SC_SOFTWARE_WRAP_MODE_V_texMain),(int(SC_USE_UV_MIN_MAX_texMain)!=0),texMainUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_texMain)!=0),texMainBorderColor,0.0,texMainArrSC);
}
#else
{
...
#endif
sc_writeFragData0Internal((((sampleMainTex(blurCoordinates[0])*0.137023)+((sampleMainTex(blurCoordinates[1])+sampleMainTex(blurCoordinates[2]))*0.239337))+((sampleMainTex(blurCoordinates[3])+sampleMainTex(blurCoordinates[4]))*0.13944))+((sampleMainTex(blurCoordinates[5])+sampleMainTex(blurCoordinates[6]))*0.052710999),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
