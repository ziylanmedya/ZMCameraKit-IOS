...
{
shadowAlpha=(1.0-dot(color.xyz,vec3(0.33333001)))*color.w;
}
#else
{
...
{
shadowAlpha=dot(color.xyz,vec3(0.33333001))*color.w;
}
#else
{
#if (sc_BlendMode_Min)
...
{
vec4 shadowSample=texture(sc_ShadowTexture,varShadowTex)*getShadowTexClipFactor();
