...
//spec_const int sc_DepthBufferMode 0 0
//spec_const int sc_RenderingSpace 1 -1
...
#endif
sc_writeFragData0Internal(varColor,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
