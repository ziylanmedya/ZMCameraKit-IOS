...
//spec_const bool SC_USE_UV_TRANSFORM_prevTex 5 0
//spec_const bool baseTexHasSwappedViews 6 0
//spec_const bool prevTexHasSwappedViews 7 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 8 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_prevTex 9 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 10 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_prevTex 11 -1
//spec_const int baseTexLayout 12 0
//spec_const int prevTexLayout 13 0
...
#endif
sc_writeFragData0Internal(vec4(mix(max(mix(max(l9_0.x,l9_1.x),min(l9_0.x,l9_1.x),0.050000001),l9_0.x),l9_0.x,isFirstFrame),0.0,0.0,1.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
