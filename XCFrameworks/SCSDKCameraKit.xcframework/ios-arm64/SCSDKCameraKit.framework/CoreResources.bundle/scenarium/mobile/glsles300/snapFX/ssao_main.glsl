...
#endif
l9_1=sc_SampleTextureBiasOrLevel(depthBufferDims.xy,depthBufferLayout,l9_2,l9_0,(int(SC_USE_UV_TRANSFORM_depthBuffer)!=0),depthBufferTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_depthBuffer,SC_SOFTWARE_WRAP_MODE_V_depthBuffer),(int(SC_USE_UV_MIN_MAX_depthBuffer)!=0),depthBufferUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_depthBuffer)!=0),depthBufferBorderColor,0.0,depthBufferArrSC);
}
#else
{
int l9_3;
...
#endif
l9_1=sc_SampleTextureBiasOrLevel(depthBufferDims.xy,depthBufferLayout,l9_3,l9_0,(int(SC_USE_UV_TRANSFORM_depthBuffer)!=0),depthBufferTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_depthBuffer,SC_SOFTWARE_WRAP_MODE_V_depthBuffer),(int(SC_USE_UV_MIN_MAX_depthBuffer)!=0),depthBufferUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_depthBuffer)!=0),depthBufferBorderColor,0.0,depthBuffer);
}
#endif
float l9_4=depthScreenToViewSpace(l9_1.x);
vec3 l9_5=vec3(((vec2(0.5)-l9_0)*vec2(sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()][0].x,sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()][1].y))*l9_4,l9_4);
vec2 l9_6=vec2(1.0)/depthBufferDims.xy;
vec2 l9_7=l9_0+vec2(l9_6.x,0.0);
vec4 l9_8;
#if (depthBufferLayout==2)
{
int l9_9;
...
#endif
l9_8=sc_SampleTextureBiasOrLevel(depthBufferDims.xy,depthBufferLayout,l9_9,l9_7,(int(SC_USE_UV_TRANSFORM_depthBuffer)!=0),depthBufferTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_depthBuffer,SC_SOFTWARE_WRAP_MODE_V_depthBuffer),(int(SC_USE_UV_MIN_MAX_depthBuffer)!=0),depthBufferUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_depthBuffer)!=0),depthBufferBorderColor,0.0,depthBufferArrSC);
}
#else
{
int l9_10;
...
#endif
l9_8=sc_SampleTextureBiasOrLevel(depthBufferDims.xy,depthBufferLayout,l9_10,l9_7,(int(SC_USE_UV_TRANSFORM_depthBuffer)!=0),depthBufferTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_depthBuffer,SC_SOFTWARE_WRAP_MODE_V_depthBuffer),(int(SC_USE_UV_MIN_MAX_depthBuffer)!=0),depthBufferUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_depthBuffer)!=0),depthBufferBorderColor,0.0,depthBuffer);
}
#endif
float l9_11=depthScreenToViewSpace(l9_8.x);
vec2 l9_12=l9_0+vec2(0.0,l9_6.y);
vec4 l9_13;
#if (depthBufferLayout==2)
{
int l9_14;
...
if (intensity>0.0)
{
l9_17=scalableAmbientObscurance(l9_0,l9_5,normalize(cross(vec3(((vec2(0.5)-l9_7)*vec2(sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()][0].x,sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()][1].y))*l9_11,l9_11)-l9_5,vec3(((vec2(0.5)-l9_12)*vec2(sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()][0].x,sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()][1].y))*l9_16,l9_16)-l9_5)));
}
else
{
l9_17=0.0;
}
float l9_18=256.0*clamp((-l9_4)*invFarPlane,0.0,1.0);
float l9_19=floor(l9_18);
sc_writeFragData0(vec4(pow(clamp(1.0-l9_17,0.0,1.0),power),l9_19*0.00390625,l9_18-l9_19,1.0));
}
