...
int ambientOcclusionGetStereoViewIndex()
{
int l9_0;
...
#endif
float l9_1=(((l9_0.y*256.0)+(l9_0.z*0.00390625))-centerDepth)*farPlaneOverBlurThreshold;
float l9_2=kernelWeight*max(0.0,1.0-(l9_1*l9_1));
sum+=(l9_0.x*l9_2);
totalWeight+=l9_2;
}
void main()
...
#if (ambientOcclusionLayout==2)
{
l9_1=sc_SampleTextureBias(ambientOcclusionLayout,ambientOcclusionGetStereoViewIndex(),l9_0,(int(SC_USE_UV_TRANSFORM_ambientOcclusion)!=0),ambientOcclusionTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_ambientOcclusion,SC_SOFTWARE_WRAP_MODE_V_ambientOcclusion),(int(SC_USE_UV_MIN_MAX_ambientOcclusion)!=0),ambientOcclusionUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_ambientOcclusion)!=0),ambientOcclusionBorderColor,0.0,ambientOcclusionArrSC);
}
#else
{
l9_1=sc_SampleTextureBias(ambientOcclusionLayout,ambientOcclusionGetStereoViewIndex(),l9_0,(int(SC_USE_UV_TRANSFORM_ambientOcclusion)!=0),ambientOcclusionTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_ambientOcclusion,SC_SOFTWARE_WRAP_MODE_V_ambientOcclusion),(int(SC_USE_UV_MIN_MAX_ambientOcclusion)!=0),ambientOcclusionUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_ambientOcclusion)!=0),ambientOcclusionBorderColor,0.0,ambientOcclusion);
...
{
float l9_3=(l9_1.y*256.0)+(l9_1.z*0.00390625);
float l9_4;
float l9_5;
vec2 l9_6;
l9_6=axis;
l9_5=kernel[0];
l9_4=l9_1.x*kernel[0];
vec2 param_22;
float param_23;
float param_24;
float param_25;
...
{
if (l9_7<int(sampleCount))
{
param_25=l9_4;
param_26=l9_5;
tap(l9_0+l9_6,l9_3,kernel[l9_7],param_25,param_26);
tap(l9_0-l9_6,l9_3,kernel[l9_7],param_25,param_26);
l9_6+=axis;
l9_5=param_26;
l9_4=param_25;
...
l9_2=(l9_4*(1.0/l9_5))+((fract(52.982918*fract(dot(gl_FragCoord.xy,vec2(0.067110561,0.0058371499))))-0.5)/255.0);
}
vec4 l9_8=vec4(l9_2,l9_1.yz,1.0);
vec4 l9_9;
#if (sc_ShaderCacheConstant!=0)
{
vec4 l9_10=l9_8;
l9_10.x=l9_2+(sc_UniformConstants.x*float(sc_ShaderCacheConstant));
l9_9=l9_10;
}
#else
{
