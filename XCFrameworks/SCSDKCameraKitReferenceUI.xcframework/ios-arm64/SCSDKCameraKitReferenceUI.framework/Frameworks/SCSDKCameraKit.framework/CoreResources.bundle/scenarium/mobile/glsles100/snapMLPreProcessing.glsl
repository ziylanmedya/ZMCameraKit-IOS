...
#endif
l9_4=sc_SampleView(screenTextureDims.xy,l9_2,screenTextureLayout,l9_5,screenTextureBias,screenTexture);
}
#else
{
int l9_6;
...
#endif
l9_4=sc_SampleView(screenTextureDims.xy,l9_2,screenTextureLayout,l9_6,0.0,screenTexture);
}
#endif
vec4 l9_7;
#if (SC_USE_CLAMP_TO_BORDER_screenTexture)
{
l9_7=mix(screenTextureBorderColor,l9_4,vec4(l9_3));
}
#else
{
l9_7=l9_4;
