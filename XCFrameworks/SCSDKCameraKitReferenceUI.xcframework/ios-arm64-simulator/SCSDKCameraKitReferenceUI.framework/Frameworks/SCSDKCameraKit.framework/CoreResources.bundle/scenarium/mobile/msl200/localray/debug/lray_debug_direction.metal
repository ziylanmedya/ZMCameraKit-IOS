...
float2 raw=z_rayDirectionsSampleView(param,sc_fragIn.sc_sysIn,sc_set0,sc_set1).xy;
float2 param_1=raw;
float3 normal=decode_normal(param_1);
sc_fragOut.fragColor=float4((normal*0.5)+float3(0.5),1.0);
return sc_fragOut;
}
} // FRAGMENT SHADER
